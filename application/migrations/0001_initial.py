# Generated by Django 3.2.18 on 2023-06-01 12:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Meaningful title of the ticket', max_length=100, unique=True, verbose_name='ticket title')),
                ...
                ('description', models.TextField(default='', help_text='Describes the issue and any action items an on-call engineer has reported', max_length=1000, verbose_name='ticket description')),
